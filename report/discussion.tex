...
\begin{figure}[h]
    \centering
    \begin{tabular}{cc}
        \includegraphics[width=0.4\linewidth]{original.png} & \includegraphics[width=0.4\linewidth]{baseline.png} \\
        \includegraphics[width=0.4\linewidth]{baselinepp.png} & \includegraphics[width=0.4\linewidth]{fcn.png} \\
    \end{tabular}
